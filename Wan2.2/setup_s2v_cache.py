...
class WanS2VCacheManager:
    def __init__(self, cache_dir="/home/caches", workspace_dir="/workspace/wan22-comfy-project/Wan2.2"):
        ...
        self.venv_path = self.workspace_dir / "venv_wan22" / "bin" / "python"
    ...
    def run_full_setup(self):
        ...
        if all_models_downloaded:
            ...
            logger.info("💡 Ready to run: ./run_s2v_single_gpu.sh or ./run_s2v_multi_gpu.sh")
        else:
    ...
    def display_status(self):
        ...
        if all(self.check_model_integrity(key) for key in self.models.keys()):
            ...
            logger.info("   ./run_s2v_single_gpu.sh  # For single GPU")
            logger.info("   ./run_s2v_multi_gpu.sh   # For multi-GPU")
        else:
